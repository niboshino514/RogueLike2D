	...
	public class CharacterFly : CharacterAbility
	{
		...
		protected virtual void HandleMovement()
		{
			...
			if (_flying)
			{
				...
				{
					horizontalMovementSpeed = Mathf.Lerp(_controller.Speed.x, horizontalMovementSpeed, Time.deltaTime * _controller.Parameters.SpeedAccelerationInAir);
					verticalMovementSpeed = Mathf.Lerp(_controller.Speed.y, verticalMovementSpeed, Time.deltaTime * _controller.Parameters.SpeedAccelerationInAir);	
				}
