...
namespace MoreMountains.CorgiEngine
{
	...
	public class CharacterStairs : CharacterAbility
	{
		...
		/// <summary>
		/// Use this method to set the input for this ability externally, useful for AI characters for example.
		/// </summary>
		/// <param name="up"></param>
		/// <param name="down"></param>
		public virtual void SetInput(bool up, bool down)
		{
			_stairsInputUp = up;
			_stairsInputDown = down;
		}
